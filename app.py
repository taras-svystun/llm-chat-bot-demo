...
if bool(uploaded_files):
    st.write([(uploaded_file.readline().decode('latin-1'), uploaded_file.getvalue().decode('latin-1'), uploaded_file.read().decode('latin-1')) for i1, uploaded_file in enumerate(uploaded_files)][:2])
    # content = ''
